...
import { Calendar, Clock, Monitor, MapPin, CheckCircle, Info, ShieldCheck, ExternalLink } from 'lucide-react';
          ...
          >
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-slate-100 pb-3">
              ...
              <div className="flex items-center gap-2 self-start sm:self-auto">
                ...
                {course.urlAulaVirtual && (
                  <a
                    href={course.urlAulaVirtual}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-emerald-50 hover:bg-emerald-100 text-emerald-700 font-bold text-xs border border-emerald-200 transition-colors"
                  >
